...
if (isset($_POST['submit'])) {
  updateFacilities($_POST['img1'], $_POST['img2'], $_POST['img3'], $_POST['img4'], $_POST['description'], $_POST['en_description']);
            ...
            <div class="side-image-form">
              ...
              <div class="admin-form2">
                ...
                <div class="field2">
                  ...
                  <textarea name="en_description" type="text" placeholder="Descripción de las instalaciones en inglés"><?php echo $info->en_description ?></textarea>
                </div>
