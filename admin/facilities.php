...
if (isset($_POST['submit'])) {
  updateFacilities($_POST['description']);
}
          ...
          <form class="admin-form2-wrapper" method="POST">
            ...
            <div class="side-image-form">
              <div class="multimedia">
                <div class="img-nav">
                  <div class="image-nav-option" onclick="selectImg(0)"><img src="../res/login.jpg" alt=""></div>
                  <div class="image-nav-option" onclick="selectImg(1)"><img src="../res/beach.jpg" alt=""></div>
                  <div class="image-nav-option" onclick="selectImg(2)"><img src="../res/bajo-mar.jpg" alt=""></div>
                </div>
                <div class="selected-img">
                  <img src="../res/actividades.png" alt="">
